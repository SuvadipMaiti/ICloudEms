    ...
    <!-- counterup JS
        ============================================ -->
    <script src="{{asset('facultypanel/js/counterup/jquery.counterup.min.js')}}"></script>
    <script src="{{asset('facultypanel/js/counterup/waypoints.min.js')}}"></script>
    <script src="{{asset('facultypanel/js/counterup/counterup-active.js')}}"></script>
    <!-- mCustomScrollbar JS
        ============================================ -->
    ...
    <!-- morrisjs JS
        ============================================ -->
    <!-- <script src="{{asset('facultypanel/js/morrisjs/raphael-min.js')}}"></script>
    <script src="{{asset('facultypanel/js/morrisjs/morris.js')}}"></script>
    <script src="{{asset('facultypanel/js/morrisjs/morris-active.js')}}"></script> -->
    <!-- morrisjs JS
        ============================================ -->
    <script src="{{asset('facultypanel/js/sparkline/jquery.sparkline.min.js')}}"></script>
    <script src="{{asset('facultypanel/js/sparkline/jquery.charts-sparkline.js')}}"></script>
    <script src="{{asset('facultypanel/js/sparkline/sparkline-active.js')}}"></script>
    <!-- calendar JS
        ============================================ -->
    <script src="{{asset('facultypanel/js/calendar/moment.min.js')}}"></script>
    <script src="{{asset('facultypanel/js/calendar/fullcalendar.min.js')}}"></script>
    <script src="{{asset('facultypanel/js/calendar/fullcalendar-active.js')}}"></script>
    <!-- plugins JS
        ============================================ -->
